<template>
	<main class="login">
		<section class="forms">
			...
			<base-button @click="signInWithGoogle" color="login"><font-awesome-icon icon="fa-brands fa-google"/><span></span> Sign in with google</base-button>
			<div class="or">
				<span class="vector"></span>
				<p>or</p>
				<span class="vector"></span>
			</div>
			<form class="log " @submit.prevent="login">
				<input 
					class="margin-bottom"
					type="email" 
